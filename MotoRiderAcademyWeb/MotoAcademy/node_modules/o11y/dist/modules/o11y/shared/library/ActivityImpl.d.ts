import { SchematizedData, TraceHeaders } from 'o11y/shared';
...
export declare class ActivityImpl implements Activity {
    ...
    discard(): void;
    terminate(userSchemaOrText?: Schema | string, userData?: SchematizedData, options?: ActivityStopOptions): void;
    getIsSampled(): boolean;
    protected _getDetail(userSchemaOrText: Schema | string, userData: SchematizedData): ActivityDetail;
    getTraceHeaders(options: TracingHeadersOptions): TraceHeaders;
