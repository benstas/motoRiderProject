...
export default class LightningPillContainer extends LightningElement {
    ...
    handleKeyDown(event) {
        ...
        switch (event.keyCode) {
            ...
            case keyCodes.up:
                ...
                event.preventDefault(); // page keeps moving if there is a scrollbar
                break;
            case keyCodes.right:
            case keyCodes.down:
                this.switchFocus(index + 1);
    ...
    handlePillBlur(event) {
        ...
        const relatedTarget =
            event.relatedTarget || event.detail[pillRelatedTarget];
